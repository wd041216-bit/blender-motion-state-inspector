...
SEMANTIC_PATTERNS = {
    ...
    "left_arm": [r"^arm\.l$", r"^leftarm$", r"^left_arm$", r"^upperarm\.l$", r"^upper_arm\.l$", r"^leftupperarm$"],
    "right_arm": [r"^arm\.r$", r"^rightarm$", r"^right_arm$", r"^upperarm\.r$", r"^upper_arm\.r$", r"^rightupperarm$"],
    "left_forearm": [r"^forearm\.l$", r"^leftforearm$", r"^left_forearm$", r"^lowerarm\.l$", r"^leftlowerarm$"],
    "right_forearm": [r"^forearm\.r$", r"^rightforearm$", r"^right_forearm$", r"^lowerarm\.r$", r"^rightlowerarm$"],
    "left_hand": [r"^hand\.l$", r"^lefthand$", r"^left_hand$", r"^wrist\.l$"],
    "right_hand": [r"^hand\.r$", r"^righthand$", r"^right_hand$", r"^wrist\.r$"],
    "left_thigh": [r"^thigh\.l$", r"^leftupleg$", r"^upperleg\.l$", r"^left_upperleg$", r"^leftupperleg$"],
    "right_thigh": [r"^thigh\.r$", r"^rightupleg$", r"^upperleg\.r$", r"^right_upperleg$", r"^rightupperleg$"],
    "left_shin": [r"^shin\.l$", r"^leftleg$", r"^calf\.l$", r"^lowerleg\.l$", r"^leftlowerleg$"],
    "right_shin": [r"^shin\.r$", r"^rightleg$", r"^calf\.r$", r"^lowerleg\.r$", r"^rightlowerleg$"],
